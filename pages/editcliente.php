...
$result = $conexion->query("select * from cliente where idcliente=" . $id);
if ($result) {
    while ($fila = $result->fetch_object()) {
        $idclienteR        = $fila->idcliente;
        $nombreclienteR    = $fila->nombre;
        $apellidoclienteR  = $fila->apellido;
        $telefonoclienteR  = $fila->telefono;
        $duiclienteR       = $fila->dui;
        $direccionclienteR = $fila->direccion;
    }
}
              ...
              <div class="sub-left-menu scroll">
                <ul class="nav nav-list">
                    ...
                    <li class="active ripple">
                      <a class="tree-toggle nav-header"><span class="fa-home fa"></span> Clientes
                ...
                <div class="col-md-12">
                  <div class="col-md-12 panel panel-info">
                    <div class="col-md-12 panel-heading">
                      <h4>Editar Informaci&oacute;n Cliente</h4>
                    </div>
                        ...
                        <form class="cmxform" id="formcliente" method="post" action="">
                          ...
                          <div class="col-md-6">
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="nombrecliente" name="nombrecliente" required value="<?php echo $nombreclienteR; ?>">
                              <span class="bar"></span>
                              <label>Nombre</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="apellidocliente" name="apellidocliente" required value="<?php echo $apellidoclienteR; ?>">
                              <span class="bar"></span>
                              <label>Apellido</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text mask-dui" id="duicliente" name="duicliente" required value="<?php echo $duiclienteR; ?>">
                              <span class="bar"></span>
                              <label>Dui</label>
                            </div>
                          </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text mask-telefono" id="telefonocliente" name="telefonocliente" required value="<?php echo $telefonoclienteR; ?>">
                              <span class="bar"></span>
                              <label>Tel&eacute;fono</label>
                            </div>

                            <div class="form-group form-animate-text" style="margin-top:40px !important;">
                              <input type="text" class="form-text" id="direccioncliente" name="direccioncliente" required value="<?php echo $direccionclienteR; ?>">
                              <span class="bar"></span>
                          ...
                          <div class="col-md-12">
                              ...
                              <button class="btn-flip btn btn-gradient btn-primary" onclick="verificar()">
                                <div class="flip">
                                  <div class="side">
                                    Modificar <span class="fa fa-save"></span>
                                  </div>
                                  <div class="side back">
                                    continuar?
                                  </div>
...
if ($bandera == "add") {
    $consulta  = "UPDATE cliente set nombre='" . $nombrecliente . "',apellido='" . $apellidocliente . "',dui='" . $duicliente . "',telefono='" . $telefonocliente . "',direccion='" . $direccioncliente . "' where idcliente='" . $baccion . "'";
