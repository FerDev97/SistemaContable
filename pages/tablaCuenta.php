...
<button type='button' class='btn ripple-infinite btn-round btn-success' data-dismiss='modal' onclick=llenarDatos(" . $fila->codigocuenta . "," . $fila->idcatalogo . ",'" . str_replace(" ",".",$fila->nombrecuenta) . "')>
<div>
<span>Enviar</span>
</div>
</button>
